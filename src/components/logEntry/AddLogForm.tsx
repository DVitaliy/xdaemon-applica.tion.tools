      ...
      <form action={submit}>
        <div className="flex flex-col gap-y-5">
          <div className="space-y-2">
            <h2 className="text-lg font-semibold leading-none tracking-tight">Add New Log Entry</h2>
            <p className="text-sm text-gray-500">Fill in the details below to create a new log entry.</p>
          </div>
